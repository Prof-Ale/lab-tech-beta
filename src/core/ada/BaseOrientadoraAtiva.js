...
export class BaseOrientadoraAtiva {
    ...
    static criarNova(conceitoAlvo = "INDEFINIDO", invarianteAlvo = "INDEFINIDO") {
        return {
            ...
            estadoAtual: {
                faseMediacao: "MATERIALIZADA", // Hipótese inicial de intervenção da ADA
            ...
            focoConceitual: {
                ...
                obstaculoPrincipal: "NENHUM",
                objetivoAtual: "DIAGNOSTICO_INICIAL"
            },
            
            planoDeMediacao: {
                estrategia: "EXPLORATORIA",
                representacaoPreferencial: "VISUAL",
    ...
    static _identificarObstaculo(boa, perfil, hab) {
        if (perfil.indicePseudoconceito > 0.6 || boa.estadoAtual.estagioConceitual === "PSEUDOCONCEITO_ESTAVEL") {
            boa.focoConceitual.obstaculoPrincipal = "PSEUDOCONCEITO";
        } else if (hab.evidenciasConceituais.indiceDependenciaVisual > 0.4) {
            boa.focoConceitual.obstaculoPrincipal = "DEPENDENCIA_VISUAL";
        } else if (hab.perfilDominante === "IMPULSIVO_ARITMETICO") {
            boa.focoConceitual.obstaculoPrincipal = "MECANIZACAO_IMPULSIVA";
        } else if (hab.errosSequenciais >= 2) {
            boa.focoConceitual.obstaculoPrincipal = "FRICCAO_COGNITIVA_ALTA";
        } else {
            boa.focoConceitual.obstaculoPrincipal = "NENHUM";
        }
    }
    ...
    static _mapearEstrategiaMediacao(boa) {
        ...
        switch (obstaculo) {
            case "DEPENDENCIA_VISUAL":
                boa.estadoAtual.faseMediacao = "VERBAL_EXTERNA";
                ...
                boa.planoDeMediacao.representacaoPreferencial = "ABSTRATA";
                boa.planoDeMediacao.mensagemMetacognitiva = "O que permanece igual quando a imagem muda?";
                break;
                
            case "PSEUDOCONCEITO":
                boa.estadoAtual.faseMediacao = "MATERIALIZADA_VISUAL";
                ...
                boa.planoDeMediacao.representacaoPreferencial = "VISUAL_ATIPICA";
                boa.planoDeMediacao.mensagemMetacognitiva = "Será que essa regra funciona em todos os casos? Vamos testar.";
                break;

            case "MECANIZACAO_IMPULSIVA":
                boa.estadoAtual.faseMediacao = "VERBAL_INTERNA";
                ...
                boa.planoDeMediacao.representacaoPreferencial = "TEXTUAL";
                boa.planoDeMediacao.mensagemMetacognitiva = "Leia o problema em voz alta antes de calcular.";
                break;
                
            case "FRICCAO_COGNITIVA_ALTA":
                boa.estadoAtual.faseMediacao = "MATERIALIZADA";
            ...
            default:
                ...
                boa.planoDeMediacao.representacaoPreferencial = "QUALQUER";
